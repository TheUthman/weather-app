...
const tipsMap = {
  ...
  "heavy rain and strong wind": [
    "☔ Heavy rain & strong winds can cause flooding and flying debris. Avoid low-lying areas, secure outdoor objects, and postpone travel until conditions improve.",
  ...
  windy: [
    "🌬️ Strong winds can knock down tree limbs and unsecured objects. Stay away from windows, secure outdoor furniture, and be cautious when driving high-profile vehicles.",
  ...
  foggy: [
    ...
    "⚠️Avoid using high beams—they reflect off the fog and make visibility even worse."
  ],
  ...
  "mostly cloudy": [
    ...
    "🌂 Keep an umbrella nearby just in case conditions change later in the day."
  ],
  
  "partly cloudy": [
    "☁️ Partly cloudy skies—a pleasant day ahead! Perfect for outdoor activities, just keep an eye on the sky for any changes.",
    "SPF 30+ sunscreen is recommended, as UV rays can still be strong through scattered clouds.",
    "Great weather for a walk or exercise outdoors without excessive heat."
  ],
  
  cloudy: [
    "☁️Cloudy conditions but no precipitation expected. Dress in layers and enjoy the mild weather.",
    "Cloud cover can keep temperatures comfortable for outdoor activities.",
    "A light jacket may come in handy, especially during the morning or evening."
  ],
  
  rain: [
    "☔ Rain expected today. Carry an umbrella, allow extra travel time, and be cautious of wet roads—braking distances double on slick surfaces.",
    "Wear waterproof shoes or boots to keep your feet dry during outdoor activities.",
    "Watch for puddles that may hide potholes or uneven surfaces."
  ],
  
  "partly sunny": [
    "⛅ Partly sunny with a mix of clouds and sun. A good day to get outside—don't forget sunscreen even when it's partly cloudy!",
    "Sunglasses can help reduce glare during brighter periods of the day.",
  ...
  sunny: [
    ...
    "Keep a reusable water bottle with you to stay hydrated throughout the day.",
    "Seek shade during the hottest part of the afternoon to avoid overheating."
  ],
  
  clear: [
    "☀️ Clear skies ahead! Perfect weather for stargazing tonight or enjoying outdoor activities. Don't forget sun protection during the day.",
